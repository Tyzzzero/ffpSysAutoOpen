...
public class Activity10 extends BaseActivity {
    ...
    protected void onStart(Page page, Model model) {
        ...
        page.locator("#aab094").dblclick();
        page.locator("#aab094").fill("0");
        page.locator("#aab104").dblclick();
        page.locator("#aab104").fill("0");
        page.locator("#aab102").dblclick();
        page.locator("#aab102").fill("0");
        page.locator("#aab105").dblclick();
        page.locator("#aab105").fill("0");
        page.locator("#aab103").dblclick();
        page.locator("#aab103").fill("0");
        page.locator("#aab106").dblclick();
        page.locator("#aab106").fill("0");
    ...
    public static void main(String[] args) {
        Activity10 activity = new Activity10();
        // 执行时传入输入文件名、模块编号和菜单编号
        activity.execute("data10.xlsx", ModuleEnum.POVERTY_ALLEVIATION, MenuEnum.LABOR_MONITORING);
    }
}
